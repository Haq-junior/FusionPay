    ...
    if (!isCurrentlyShown) {
        ...
        const scrambleInterval = setInterval(() => {
          if (scrambleCount < maxScrambles) {
            ...
            gsap.fromTo(elementRef.current, 
              { opacity: 0, scale: 0.8, color: '#3B82F6' },
              { opacity: 1, scale: 1, color: '#FFFFFF', duration: 0.5, ease: "back.out(1.7)" }
            )
          }
        }, 100)
      }
      ...
      try {
        ...
        gsap.fromTo(elementRef.current,
          ...
          { filter: 'brightness(1)', scale: 1, duration: 0.3 }
        )
      } catch (err) {
          ...
          <div className="w-full relative">
            ...
            >
              ...
              <div className="absolute inset-0 opacity-20">
                ...
                <div className="absolute bottom-6 left-8 w-12 h-12 border border-white/30 rounded-full"></div>
              ...
              {isCardFrozen && (
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-white font-semibold text-lg">Card Frozen</div>
                  </div>
                </div>
              )}
            </div>
